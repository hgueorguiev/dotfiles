...
# CT Command params:
# --kibana will bring up kibana and admin tools) or --postfix.
# --preserve_es_index startup without building empty index

history_search() {
  t=$(history | fzf -q$1)
  pt=$(echo $t | sed 's/^ *//g' | cut -d' ' -f1)
  print -z '!'$pt
}
...
alias gitd='git diff'
alias bounce='ct stop; ct up'
alias up='ct up --preserve_es_index'
